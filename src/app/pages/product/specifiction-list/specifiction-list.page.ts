...
@Component({
  selector: 'app-specifiction-list',
  templateUrl: './specifiction-list.page.html',
  styleUrls: ['./specifiction-list.page.scss'],
})
export class SpecifictionListPage implements OnInit {
...
sortingButtonName: ""
  ...
  column_name: "type",
  display_name: "Specification Type",
  sortingButtonName: ""
  }
,{
  column_name: "data",
...
statusChange(specId)
{  
this.changeStatusSubscribe =this.http.put('specification/activeSpec/'+specId , '').subscribe(
  (res:any) => {
    this.commonUtils.presentToast('success', res.message);
...
handler: () => {
  ...
  if(_identifire == 'single'){
    ...
    this.deleteDataSubscribe = this.http.put("specification/delete/"+_item.id,'').subscribe(
      (res:any) => {
